...
rsync -avzt -m --delete --exclude="*.pyc" --exclude="*.pyo" --exclude="__pycache__" $curdir/ddcz $curdir/graveyard $curdir/dragon $curdir/manage.py $curdir/static $machine:$remote_root/
