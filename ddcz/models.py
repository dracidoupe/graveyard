...
class DrdReklamaAcls(models.Model):
    bannerid = models.IntegerField()
    acl_con = models.CharField(max_length=6)
    acl_type = models.CharField(max_length=9)
    acl_data = models.CharField(max_length=255)
    acl_ad = models.CharField(max_length=10)
    acl_order = models.PositiveIntegerField()

    class Meta:
        managed = False
        db_table = 'drd_reklama_acls'
        unique_together = (('bannerid', 'acl_order'),)


class DrdReklamaAdclicks(models.Model):
    bannerid = models.IntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'drd_reklama_adclicks'


class DrdReklamaAdstats(models.Model):
    views = models.IntegerField()
    clicks = models.IntegerField()
    day = models.DateField(primary_key=True)
    hour = models.IntegerField()
    bannerid = models.SmallIntegerField()
    zoneid = models.SmallIntegerField()
    source = models.CharField(max_length=50)

    class Meta:
        managed = False
        db_table = 'drd_reklama_adstats'
        unique_together = (('day', 'hour', 'bannerid', 'zoneid', 'source'),)


class DrdReklamaAdviews(models.Model):
    bannerid = models.IntegerField()
    zoneid = models.IntegerField()
    t_stamp = models.DateTimeField()
    host = models.CharField(max_length=255)
    ...
    class Meta:
        managed = False
        db_table = 'drd_reklama_adviews'


class DrdReklamaAffiliates(models.Model):
    ...
    publiczones = models.CharField(max_length=1)

    class Meta:
        managed = False
        db_table = 'drd_reklama_affiliates'


class DrdReklamaBanners(models.Model):
    ...
    bannertext = models.CharField(max_length=255)
    description = models.CharField(max_length=255)
    autohtml = models.CharField(max_length=1)
    ...
    class Meta:
        managed = False
        db_table = 'drd_reklama_banners'


class DrdReklamaClients(models.Model):
    ...
    clientusername = models.CharField(max_length=64)
    clientpassword = models.CharField(max_length=64)
    expire = models.DateField(blank=True, null=True)
    activate = models.DateField(blank=True, null=True)
    permissions = models.IntegerField(blank=True, null=True)
    language = models.CharField(max_length=64, blank=True, null=True)
    active = models.CharField(max_length=1)
    weight = models.IntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'drd_reklama_clients'


class DrdReklamaConfig(models.Model):
    configid = models.IntegerField(primary_key=True)
    config_version = models.DecimalField(max_digits=7, decimal_places=3)
    table_border_color = models.CharField(max_length=7, blank=True, null=True)
    table_back_color = models.CharField(max_length=7, blank=True, null=True)
    table_back_color_alternative = models.CharField(max_length=7, blank=True, null=True)
    main_back_color = models.CharField(max_length=7, blank=True, null=True)
    my_header = models.CharField(max_length=255, blank=True, null=True)
    my_footer = models.CharField(max_length=255, blank=True, null=True)
    language = models.CharField(max_length=32, blank=True, null=True)
    name = models.CharField(max_length=32, blank=True, null=True)
    company_name = models.CharField(max_length=255, blank=True, null=True)
    override_gd_imageformat = models.CharField(max_length=4, blank=True, null=True)
    begin_of_week = models.IntegerField(blank=True, null=True)
    percentage_decimals = models.IntegerField(blank=True, null=True)
    type_sql_allow = models.CharField(max_length=1, blank=True, null=True)
    type_url_allow = models.CharField(max_length=1, blank=True, null=True)
    type_web_allow = models.CharField(max_length=1, blank=True, null=True)
    type_html_allow = models.CharField(max_length=1, blank=True, null=True)
    type_web_mode = models.IntegerField(blank=True, null=True)
    type_web_dir = models.CharField(max_length=255, blank=True, null=True)
    type_web_ftp = models.CharField(max_length=255, blank=True, null=True)
    type_web_url = models.CharField(max_length=255, blank=True, null=True)
    admin = models.CharField(max_length=64, blank=True, null=True)
    admin_pw = models.CharField(max_length=64, blank=True, null=True)
    admin_fullname = models.CharField(max_length=255, blank=True, null=True)
    admin_email = models.CharField(max_length=64, blank=True, null=True)
    admin_email_headers = models.CharField(max_length=64, blank=True, null=True)
    admin_novice = models.CharField(max_length=1, blank=True, null=True)
    default_banner_weight = models.IntegerField(blank=True, null=True)
    default_campaign_weight = models.IntegerField(blank=True, null=True)
    client_welcome = models.CharField(max_length=1, blank=True, null=True)
    client_welcome_msg = models.TextField(blank=True, null=True)
    content_gzip_compression = models.CharField(max_length=1, blank=True, null=True)
    userlog_email = models.CharField(max_length=1, blank=True, null=True)
    userlog_priority = models.CharField(max_length=1, blank=True, null=True)
    gui_show_campaign_info = models.CharField(max_length=1, blank=True, null=True)
    gui_show_campaign_preview = models.CharField(max_length=1, blank=True, null=True)
    gui_show_banner_info = models.CharField(max_length=1, blank=True, null=True)
    gui_show_banner_preview = models.CharField(max_length=1, blank=True, null=True)
    gui_show_banner_html = models.CharField(max_length=1, blank=True, null=True)
    gui_hide_inactive = models.CharField(max_length=1, blank=True, null=True)
    qmail_patch = models.CharField(max_length=1, blank=True, null=True)
    updates_frequency = models.IntegerField(blank=True, null=True)
    updates_timestamp = models.IntegerField(blank=True, null=True)
    updates_last_seen = models.DecimalField(max_digits=7, decimal_places=3, blank=True, null=True)
    allow_invocation_plain = models.CharField(max_length=1, blank=True, null=True)
    allow_invocation_js = models.CharField(max_length=1, blank=True, null=True)
    allow_invocation_frame = models.CharField(max_length=1, blank=True, null=True)
    allow_invocation_xmlrpc = models.CharField(max_length=1, blank=True, null=True)
    allow_invocation_local = models.CharField(max_length=1, blank=True, null=True)
    allow_invocation_interstitial = models.CharField(max_length=1, blank=True, null=True)
    allow_invocation_popup = models.CharField(max_length=1, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'drd_reklama_config'


class DrdReklamaImages(models.Model):
    filename = models.CharField(primary_key=True, max_length=128)
    contents = models.TextField()

    class Meta:
        managed = False
        db_table = 'drd_reklama_images'


class DrdReklamaSession(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'drd_reklama_session'


class DrdReklamaUserlog(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'drd_reklama_userlog'


class DrdReklamaZones(models.Model):
    ...
    width = models.SmallIntegerField()
    height = models.SmallIntegerField()
    cachecontents = models.TextField(blank=True, null=True)
    cachetimestamp = models.IntegerField()
    chain = models.TextField()
    append = models.TextField()

    class Meta:
        managed = False
        db_table = 'drd_reklama_zones'
